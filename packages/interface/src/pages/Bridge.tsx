...
const OUTPUT_TYPES = [
  { id: 'stx', label: 'STX', description: 'Native Stacks token' },
  { id: 'sbtc', label: 'sBTC', description: 'Stacks Bitcoin' },
];
    ...
    <div className="max-w-xl mx-auto">
      <div className="text-center mb-10">
        ...
        <p className="text-zinc-400 text-lg">
          Transfer your tokens from Arbitrum Sepolia to Stacks
        </p>
      </div>
      ...
      <div className="mt-8 glass rounded-2xl p-6">
        ...
        <ol className="space-y-3 text-zinc-400">
          <li className="flex items-start gap-3">
            ...
            <span>Lock tokens on Arbitrum Sepolia</span>
          </li>
          <li className="flex items-start gap-3">
